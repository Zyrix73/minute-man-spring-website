          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-6 border-t border-gray-200">
              <div>
                ...
                <div className="text-[#1B3A6B] text-sm font-medium">Millbury, MA</div>
              </div>
              <div>
                <div className="text-[#6B7FA3] text-xs uppercase tracking-widest font-semibold mb-1">
                  Phone
                </div>
                <a href="tel:+15082996100" className="text-[#1B3A6B] text-sm font-medium hover:text-[#6B7FA3] transition-colors">
                  508-299-6100
                </a>
              </div>
              <div>
                ...
                <div className="text-[#1B3A6B] text-sm font-medium">MA, New England &amp; Worldwide</div>
              </div>
            </div>
          </div>
        </div>
