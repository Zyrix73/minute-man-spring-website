import { Phone, MapPin, Mail, ArrowRight, Users, Clock } from 'lucide-react';
              ...
              <ul className="space-y-3">
                ...
                <li className="pt-1">
                  <a
                    ...
                    aria-label="Join the Minuteman Spring team — view open positions"
                  >
        ...
        <div className="border-t border-[#6B7FA3]/20 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-8 h-8 rounded-full bg-[#C8A96E]/10 flex-shrink-0">
              <Users size={15} className="text-[#C8A96E]" aria-hidden="true" />
            </div>
            <div>
              <p className="text-white text-sm font-semibold leading-tight">
                We're hiring skilled spring makers
              </p>
              <p className="text-gray-500 text-xs mt-0.5">
                Join a team with 79+ years of manufacturing excellence in Millbury, MA
              </p>
            </div>
          </div>
          <a
            ...
            aria-label="Apply for a position at Minuteman Spring Company"
          >
